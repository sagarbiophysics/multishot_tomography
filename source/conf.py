...
copyright = 'Sagar Khavnekar, licensed under GPLv3'
...
html_theme_options = {
   ...
   'github_user': 'sagarbiophysics',
   'github_repo': 'multishot_tomography',
   'github_button': True,
   'github_type': 'star',
...
latex_documents = [("index", "MultishotTomo.tex", "Multishot Tomography", "Sagar Khavnekar", "manual", "toctree_only")]
